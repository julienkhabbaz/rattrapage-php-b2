...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'Vich\\UploaderBundle\\Naming\\UniqidNamer.produit_image' => 'getUniqidNamer_ProduitImageService',
    ...
    protected function getAppControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\AppController', $this));
    ...
    /**
     * Gets the public 'Vich\UploaderBundle\Naming\UniqidNamer.produit_image' shared service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer
     */
    protected function getUniqidNamer_ProduitImageService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/vich/uploader-bundle/src/Naming/NamerInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/vich/uploader-bundle/src/Naming/Polyfill/FileExtensionTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/vich/uploader-bundle/src/Naming/UniqidNamer.php';

        return $this->services['Vich\\UploaderBundle\\Naming\\UniqidNamer.produit_image'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('gfkWe+HEO2', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mzH-BQ+gOQ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('produit_image', $e, $f, $g));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('produit_image', $e, $f, $g));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('produit_image', $e, $f, $g));
    ...
    /**
     * Gets the private '.service_locator.v16iTRs' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_V16iTRsService()
    {
        return $this->privates['.service_locator.v16iTRs'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\AppController::accueil' => ['privates', '.service_locator.D_VxfLH', 'get_ServiceLocator_DVxfLHService', false],
            'App\\Controller\\AppController::ficheProduit' => ['privates', '.service_locator.J966qaa', 'get_ServiceLocator_J966qaaService', false],
            'App\\Controller\\AppController::listeProduits' => ['privates', '.service_locator.D_VxfLH', 'get_ServiceLocator_DVxfLHService', false],
            'App\\Controller\\CartController::add' => ['privates', '.service_locator.qQRbIWD', 'get_ServiceLocator_QQRbIWDService', false],
            'App\\Controller\\CartController::index' => ['privates', '.service_locator.qQRbIWD', 'get_ServiceLocator_QQRbIWDService', false],
            'App\\Controller\\CartController::remove' => ['privates', '.service_locator.qQRbIWD', 'get_ServiceLocator_QQRbIWDService', false],
            'App\\Controller\\CartController::removeAll' => ['privates', '.service_locator.qQRbIWD', 'get_ServiceLocator_QQRbIWDService', false],
            'App\\Controller\\AppController:accueil' => ['privates', '.service_locator.D_VxfLH', 'get_ServiceLocator_DVxfLHService', false],
            'App\\Controller\\AppController:ficheProduit' => ['privates', '.service_locator.J966qaa', 'get_ServiceLocator_J966qaaService', false],
            'App\\Controller\\AppController:listeProduits' => ['privates', '.service_locator.D_VxfLH', 'get_ServiceLocator_DVxfLHService', false],
            'App\\Controller\\CartController:add' => ['privates', '.service_locator.qQRbIWD', 'get_ServiceLocator_QQRbIWDService', false],
            ...
            'App\\Controller\\AppController::accueil' => '?',
            'App\\Controller\\AppController::ficheProduit' => '?',
            'App\\Controller\\AppController::listeProduits' => '?',
    ...
    /**
     * Gets the private 'App\Form\ProduitSearchType' shared autowired service.
     *
     * @return \App\Form\ProduitSearchType
     */
    protected function getProduitSearchTypeService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/AbstractType.php';
        include_once \dirname(__DIR__, 4).'/src/Form/ProduitSearchType.php';

        return $this->privates['App\\Form\\ProduitSearchType'] = new \App\Form\ProduitSearchType();
    }
    ...
    protected function getCartServiceService()
    {
        ...
        return $this->privates['App\\Service\\Cart\\CartService'] = new \App\Service\Cart\CartService(($this->services['session'] ?? $this->getSessionService()), ($this->privates['App\\Repository\\ProduitRepository'] ?? $this->getProduitRepositoryService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Sryz1+UFl8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o1+72TEi4U', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4o-n7Xgqxu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JYwLnhcvbm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3KK9lpBPTd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.v16iTRs'] ?? $this->get_ServiceLocator_V16iTRsService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getForm_RegistryService()
    {
        ...
        return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Form\\ProduitSearchType' => ['privates', 'App\\Form\\ProduitSearchType', 'getProduitSearchTypeService', false],
        ...
        return [
            ...
            'vich_uploader.mappings' => [
                'produit_image' => [
                    ...
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\UniqidNamer.produit_image',
                        'options' => [
